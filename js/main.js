...
const AI_KNOWLEDGE = {
  greetings: ['مرحبا','هلا','السلام','صباح','مساء','اهلا','هاي','هاى','كيف حالك','ازيك','مرحبتين','حياك','يهلا','شلونك','كيفك','صباح الخير','مساء الخير','يسلمو','اهلين'],
  help: ['مساعدة','ساعدني','كيف','ما هو','وش','ايش','ما هي','اعرف','ابي اعرف','ممكن','وضح','شرح','اشرح لي','مالفرق'],
  services: ['خدمات','ايش تقدمون','ماذا تقدمون','الخدمات','عندكم','تقدرون','ماذا عندكم','خدماتكم','تساعدون','ايش تسوون','شو خدماتكم'],
  health: ['صحي','طبي','تمريض','nursing','صحة','طب','صيدلة','علاج','care plan','case study','logbook','اشعة','مختبر','طب اسنان','علاج طبيعي','قبالة','ولادة','اخصائي','تمريضي','صحية','نرسينج','pharmacology','anatomy','physiology','micro','مايكرو','باثو','هيستو','بيوكيم','micro biology'],
  cs: ['برمجة','كمبيوتر','حاسب','java','python','html','بايثون','تطبيق','موقع','database','sql','كود','مشروع برمجة','c++','c#','javascript','react','flutter','android','ios','swift','kotlin','php','laravel','django','machine learning','ai','ذكاء اصطناعي','network','شبكات','سيبر','cyber','information','معلومات','حاسوب','برنامج','اندرويد','تطبيقات'],
  science: ['علمي','فيزياء','كيمياء','احياء','رياضيات','احصاء','تفاضل','جبر','حساب','مسائل','تحليل','statistics','calculus','algebra','biology','chemistry','physics','math','lab','تجربة','مختبر علمي','تقرير مختبر'],
  business: ['اداري','محاسبة','ادارة','اقتصاد','محاسبي','تسويق','موارد','mis','قانون','تجاري','مالية','ميزانية','تدقيق','كلفة','تكاليف','management','accounting','marketing','finance','hr','موارد بشرية','حوكمة','اعمال','ريادة','مشروع اداري','business','تجارة'],
  ksu: ['كاو','ksu','الملك سعود','ca','مشاريع ksu','اكسل','وورد','ريد','access','مشاريع جامعة','المشتركة','جامعة الملك سعود','مشروع الجامعة','مشروع مشترك','مواد مشتركة','سنة اولى ksu','cas','اكسس','ريد برو','مشروع الريد','خريطة ذهنية ksu','mind map ksu'],
  price: ['سعر','كم','تكلفة','غالي','رخيص','بكم','أسعار','ميزانية','كم السعر','بكم تبيعون','الثمن','كلفني','يكلف','تعريفة','كتالوج اسعار','قائمة اسعار'],
  order: ['طلب','اطلب','كيف اطلب','شراء','ارسل','احتاج','اريد طلب','ابي اطلب','طريقة الطلب','ارسال الطلب','تقديم طلب','بدي اطلب','خطوات الطلب'],
  payment: ['دفع','تحويل','انماء','بنك','ايبان','حساب','دفعة','iban','الحساب البنكي','حولت','اثبات تحويل','ايصال','وصل دفع','طريقة الدفع','كيف ادفع'],
  contact: ['تواصل','واتساب','تيليجرام','رقم','اتصل','رسالة','رقم الهاتف','كيف اتواصل','وين تواصل','ابي اتكلم','ابي احكي'],
  preparatory: ['تحضيري','انتقالي','سنة اولى','مستوى اول','مشترك','مواد تحضيرية','prep','مستوى تحضيري','سنة تحضيرية'],
  english: ['انجليزي','لغة انجليزية','english','essay','grammar','ترجمة','translation','writing','reading','ielts','toefl','كتابة انجليزي','مقالة انجليزي','paragraph','composition'],
  school: ['مدرسة','ثانوية','متوسطة','ابتدائية','طالب مدرسة','واجب مدرسة','مشروع مدرسة','school','اسئلة مدرسية','اختبار مدرسة'],
  tools: ['ادوات','مجانية','pdf','gpa','معدل','حاسبة','مؤقت','qr','تحويل','حساب المعدل','صانع qr','عداد كلمات','ترجمة مجانية','بومودورو','pomodoro','word count'],
  delivery: ['تسليم','متى','وقت','كم يوم','سرعة','توصيل','ينتهي','ينجز','هل تقدر','وقت الانجاز','كم الوقت','متى يجهز'],
  quality: ['جودة','ضمان','موثوق','مضمون','احترافي','دقة','مستوى','ثقة','اتمنى جيد','هل الجودة','نوعية العمل'],
  privacy: ['سرية','خصوصية','سري','بياناتي','معلوماتي','حمايتي','هل آمن','confidential','privacy'],
  universities: ['جامعة','جامعات','كلية','الملك عبدالعزيز','الملك فهد','الامام','الاميرة نورة','التقنية','القصيم','حائل','الطائف','الباحة','تبوك','جازان','طيبة','جدة','KAUST','الملك خالد','نجران','جيزان','شقراء','المجمعة','القصيم','الجوف','نجد','الأميرة','pnu','kau','kfupm'],
  nav: ['انتقل','اذهب','افتح','وين','اين','رابط','صفحة','ابي اروح','روحني','وجهني'],
  discount: ['خصم','تخفيض','عرض','اوفر','رخص','اقل سعر','هل عندكم خصم','كوبون','عرض خاص'],
  revision: ['تعديل','تصحيح','مراجعة','تغيير','اعادة','ما عجبني','مو كامل','ناقص','تعديلات'],
  urgent: ['عاجل','مستعجل','اليوم','الان','بسرعة','ضروري','بكرا','موعد','deadline','تسليم اليوم','مهلة'],
  aboutus: ['من انتم','عن المنصة','عن سند','معلومات','تاريخ المنصة','من وراء','الشركة','المؤسسة','كريتيفا'],
};
...
const AI_RESPONSES = {
  ...
  delivery: {
    text: '⚡ **مواعيد التسليم:**\n\n🟢 **مشاريع KSU** — 4 إلى 48 ساعة\n🟡 **واجبات وتقارير** — 24 ساعة\n🔵 **أبحاث ومشاريع كبيرة** — 48 إلى 72 ساعة\n🔴 **تسليم عاجل** — يُمكن التنسيق عبر واتساب\n\n⚠️ الوقت يُحسب من لحظة استلام جميع التفاصيل وتأكيد الدفع.',
    chips: ['💬 تواصل معنا', '📋 كيف أطلب؟', '💰 الأسعار']
  },
  quality: {
    text: '✅ **ضمان الجودة في منصة سند:**\n\n🏆 أكثر من **5000 طالب** استفادوا من خدماتنا\n📋 جميع الأعمال تُنجز بأعلى المعايير الأكاديمية\n🔄 **تعديلات مجانية** حتى رضاك التام\n🎓 فريق من المتخصصين في كل تخصص\n🔒 **خصوصية تامة** لبياناتك ومعلوماتك\n\n99% معدل رضا الطلاب 🌟',
    chips: ['📋 كيف أطلب؟', '💰 الأسعار', '💬 تواصل معنا']
  },
  privacy: {
    text: '🔒 **خصوصيتك أولويتنا:**\n\n✅ بياناتك محمية 100% ولا تُشارك مع أي جهة\n✅ جميع المحادثات سرية تامة\n✅ لا نحتفظ بمعلوماتك بعد انتهاء الطلب\n✅ الدفع آمن عبر تحويل بنكي موثوق\n\n🛡️ نضمن لك الأمان والسرية في كل خطوة.',
    chips: ['📋 كيف أطلب؟', '💬 تواصل معنا']
  },
  discount: {
    text: '🏷️ **العروض والخصومات:**\n\n💡 أسعارنا تنافسية ومناسبة للطلاب دائمًا\n🎓 خصومات خاصة للطلاب الجدد — تواصل معنا\n📦 خصم على الطلبات المتعددة\n📢 تابع قناة التيليجرام لمعرفة آخر العروض!\n\n👉 @Helping_KSU',
    chips: ['💬 تواصل معنا', '📢 قناة تيليجرام', '💰 الأسعار'],
    navLinks: [{ text: '📢 قناة تيليجرام', href: 'https://t.me/Helping_KSU/2697' }]
  },
  revision: {
    text: '🔄 **سياسة التعديلات:**\n\n✅ تعديلات مجانية غير محدودة حتى رضاك\n✅ يمكنك طلب التعديل مباشرة عبر واتساب\n✅ نلتزم بتطبيق التعديلات في أسرع وقت\n\n💬 فقط تواصل معنا وأخبرنا ما تحتاجه بالضبط!',
    chips: ['💬 تواصل معنا', '📋 كيف أطلب؟']
  },
  urgent: {
    text: '🚨 **تسليم عاجل — نعم نقدر!**\n\n⚡ مشاريع KSU تُسلَّم في 4-48 ساعة\n🔥 بعض الطلبات ممكن تسليمها خلال ساعات\n📱 تواصل معنا الآن عبر واتساب لتأكيد الوقت\n\n💡 كلما أرسلت التفاصيل مبكرًا، كلما ضمنت تسليمك في الوقت!',
    chips: ['📱 واتساب الآن', '📋 كيف أطلب؟'],
  },
  aboutus: {
    text: '🏛️ **عن منصة سند التعليمية:**\n\n📅 تأسست عام 2024 لخدمة الطلاب في المملكة\n🎓 نخدم أكثر من **50 جامعة وكلية** سعودية\n👥 فريق متخصص في **200+ تخصص أكاديمي**\n⭐ أكثر من **5000 طالب** وثقوا بنا\n🏢 المؤسسة: **كريتيفا جلوبال ات**\n\n🚀 هدفنا: دعم أكاديمي متميز لكل طالب!',
    chips: ['📚 استعرض الخدمات', '💬 تواصل معنا', '🎓 مشاريع KSU']
  }
};
...
function getAIResponse(text) {
  ...
  const map = {
    ...
    preparatory: 'preparatory', english: 'english', school: 'school',
    tools: 'tools', nav: 'nav', default: 'default',
    delivery: 'delivery', quality: 'quality', privacy: 'privacy',
    discount: 'discount', revision: 'revision', urgent: 'urgent',
    aboutus: 'aboutus', universities: 'contact'
  };
...
function injectAIWidget() {
  ...
  btn.title = 'سند الذكي — اسألني أي شيء!';
...
function injectAILabel() {
  /* small floating label above AI btn */
  if (document.getElementById('ai-side-label')) return;
  const lbl = document.createElement('div');
  lbl.id = 'ai-side-label';
  lbl.className = 'ai-side-label';
  lbl.textContent = 'مساعد ذكي';
